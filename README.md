...
* Exibir a lista de materiais cadastrados em uma interface gráfica.
* Pesquisar materiais por título, autor ou ISBN.
* Editar informações de materiais já cadastrados.
* Remover materiais do sistema quando necessário.
* Identificar automaticamente o tipo de material utilizando herança e polimorfismo.
* Validar os dados inseridos pelo usuário, exibindo mensagens de erro para entradas inválidas ou incompletas.
...
* **Polimorfismo:** tratamento uniforme de diferentes tipos de materiais através de métodos sobrescritos.
